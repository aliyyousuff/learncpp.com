...
1e) Modify your main() function to call getArithmeticFunction(). Call the return value 
from that function with your inputs and print the result.
...
int main()
{
    int integer1{ get_integer()};
    int integer2{ get_integer() };
    char operat{ get_operator()};
    auto arithmatic_operation{ get_arithmatic_function(operat)};

    std::cout << arithmatic_operation(integer1, integer2) << '\n';
    return 0;
}